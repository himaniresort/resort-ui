...
import GuestsAndRooms, {
  GuestsAndRoomsPropsType,
  GuestsAndRoomsState,
} from "./GuestsRooms";
...
export default function RoomTypeComponent({
  ...
  const handleReserveBooking = (roomType: any) => {
    ...
    const dateErrorCheck = dateChangeCheck(
      datePickerStore.checkIn,
      datePickerStore.checkOut
    );
  ...
  return (
    <>
                ...
                <CardContent sx={{ p: 3, width: "100%" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      {(
                        roomType.cost *
                        (guestsAndRooms.guests[roomType.type] || 1) *
                        (guestsAndRooms.rooms[roomType.type] || 1) *
                        numberOfNights
                      ).toLocaleString()}
                    </Typography>
                    <GuestsAndRooms
                      guestsAndRoomsProps={guestsAndRoomsProps}
                    ></GuestsAndRooms>
                    <Box>
                      <Button
                        variant="contained"
      ...
      <RoomTypeDialog
        roomType={roomType}
        openDialog={openRoomTypeDialog}
        setOpenDialog={setOpenRoomTypeDialog}
      />
    </>
  );
}
